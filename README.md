...
* Download the [BrickBreaker.jar](http://brickbreaker.us.to/BrickBreaker.jar) and start it with the command: ``java -jar BrickBreaker.jar`` or double click on Windows and OS X.
